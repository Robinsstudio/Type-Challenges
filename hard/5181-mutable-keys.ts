...
type MutableKeys<T> = keyof {
  [K in keyof T as Equal<Partial<Readonly<Record<K, T[K]>>>, Partial<Pick<T, K>>> extends false ? K : never]: T[K]
}

// https://github.com/type-challenges/type-challenges/issues/5221
// type MutableKeys<T> = keyof {
//   [K in keyof T as Equal<Pick<T, K>, Readonly<Pick<T, K>>> extends false ? K : never]: T[K]
// }
