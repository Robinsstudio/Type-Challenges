...
type UnmergedEnum<T extends readonly string[], N extends boolean = false, Counter extends unknown[] = []> = T extends readonly [infer First extends string, ...infer Rest extends string[]]
  ? {
    readonly [K in Capitalize<First>]: N extends true ? Counter['length'] : First
  } & UnmergedEnum<Rest, N, [...Counter, unknown]>
  : {};
...
type Enum<T extends readonly string[], N extends boolean = false> = Merge<UnmergedEnum<T, N>>
