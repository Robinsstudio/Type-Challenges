...
type Subsequence<T extends unknown[], U extends unknown[] = []> = T extends [infer First, ...infer Rest]
  ? [...U, First] | Subsequence<Rest, [...U, First]> | Subsequence<Rest, U>
  : [];

// https://github.com/type-challenges/type-challenges/issues/9091
