...
type isFalsy<T> = T extends false | 0 | '' | [] | undefined | null
  ? true
...
// https://github.com/type-challenges/type-challenges/issues/23963
// type IsFalse = Record<string, never> | [] | '' | 0 | null | undefined | false
