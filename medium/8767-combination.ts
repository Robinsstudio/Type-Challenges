...
type Combination<T extends string[], U extends string = T[number], V extends string = U> = U extends U
...
// type Combination<T extends string[], U extends string = T[number], V extends string = U> = U extends string
//   ? U | `${U} ${Combination<T, Exclude<V, U>>}`
//   : never;
