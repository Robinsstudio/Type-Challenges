...
// Extra check on Function type found thanks to https://github.com/type-challenges/type-challenges/issues/22829
type DeepReadonly<T> = {
  readonly [K in keyof T]: T[K] extends object ? T[K] extends Function ? T[K] : DeepReadonly<T[K]> : T[K]
};

// https://github.com/type-challenges/type-challenges/issues/22456
// type DeepReadonly<T> = {
