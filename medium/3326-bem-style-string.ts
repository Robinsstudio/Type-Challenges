...
type TupleToUnion<T extends string[], U extends string> = [T[number]] extends [never] ? '' : `${U}${T[number]}`

type BEM<B extends string, E extends string[], M extends string[]> = `${B}${TupleToUnion<E, '__'>}${TupleToUnion<M, '--'>}`;
