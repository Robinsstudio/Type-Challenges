...
import { IsNever } from './1042-is-never';

type IsTuple<T> = [T, IsNever<T>] extends [readonly [] | readonly [infer _, ...infer __], false] ? true : false;

/* _____________ Test Cases _____________ */
import type { Equal, Expect } from '../utils'

type cases = [
  Expect<Equal<IsTuple<[1, 2, 3]>, true>>,
