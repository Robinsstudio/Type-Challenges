...
type NotAnyOf<T, U> = U extends [infer First, ...infer Rest]
  ? First extends T
  ? never
  : NotAnyOf<T, Rest>
  : T;
...
type RemoveIndexSignature<T> = {
  [K in keyof T as NotAnyOf<K, [number, string, symbol]>]: T[K]
}

// https://github.com/type-challenges/type-challenges/issues/20786
// type RemoveIndexSignature<T> = {
